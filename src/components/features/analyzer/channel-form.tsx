    ...
    <form className="mt-10 space-y-4" onSubmit={onSubmit}>
      <label className="block space-y-2">
        ...
        <div className="flex flex-col gap-3 sm:flex-row">
          ...
          >
            {isLoading ? "Building workspace..." : "Analyze channel"}
          </button>
        </div>
      </label>

      <div className="flex flex-wrap items-center gap-2 text-sm text-[var(--muted)]">
        <span>Try a sample channel:</span>
      ...
      <p className="text-sm leading-6 text-[var(--muted)]">
        Paste a public handle, custom URL, or channel ID. We pull recent uploads,
        score them by momentum, and organize the channel into one decision-ready
        workspace.
      </p>
